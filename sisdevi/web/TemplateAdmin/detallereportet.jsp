...
<%
    ...
    DetalleReporte reporte = ServicioDetalleReporte.getInstancia().getDetalleTestigoPorId(id);
   if (reporte.getId()==null){
       response.sendRedirect("agregardetallereportet.jsp?id="+id);
   }else{
%>
    ...
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i>Detalle del Reporte<a href="agregardetallereportet.jsp?id=<%=id%>">Agregar Detalle al Reporte</a></h4>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="editardetallereportet.jsp?id=<%=reporte.getId()%>"><i class="icon-edit"></i></a></td>
