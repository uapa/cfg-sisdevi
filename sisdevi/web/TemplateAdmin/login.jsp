                ...
                <form class="form-vertical login-form cmxform" id="newsletter" action="/sisdevi/LoginServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            <i class="icon-user"></i>
                            <input type="text" name="username" class="form-control" placeholder="Usuario" autofocus="autofocus" data-rule-required="true" data-msg-required="Please enter your username." required/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            <i class="icon-lock"></i>
                            <input type="password" name="password" class="form-control" placeholder="Contraseña" data-rule-required="true" data-msg-required="Please enter your password." required/>
                        </div>
                    </div>
                    <!-- /Input Fields -->
