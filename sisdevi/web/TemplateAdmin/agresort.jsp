...
<%
    ...
    if (agresor.getId() == null) {
        response.sendRedirect("agregaragresort.jsp?id=" + id);
    } else {
%>
    ...
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i>Datos del agresor <a href="agregaragresort.jsp?id=<%=id%>">Agregar agresor</a></h4>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="editaragresort.jsp?id=<%=agresor.getId()%>"><i class="icon-edit"></i></a></td>
