...
<%
    ...
    if (episodio == null) {
        response.sendRedirect("agregarepisodiot.jsp?id=" + id);
    } else {
%>
<div class="row">
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i>Episodios <a href="agregarepisodiot.jsp?id=<%=id%>">Agregar Episodio</a></h4>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                    ...
                    <c:forEach items="<%=episodio%>" var="episodio">
                        <tr>
                            ...
                            <td><a href="editarepisodiot.jsp?id=${episodio.getId()}"><i class="icon-edit"></i></a></td>
